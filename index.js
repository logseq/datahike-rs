...
const { init, databaseExists, createDatabase, deleteDatabase, transact, query, pull, pullMany, entity, datoms, schema, reverseSchema } = nativeBinding
...
module.exports.reverseSchema = reverseSchema
